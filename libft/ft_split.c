...
/*   Updated: 2023/03/21 17:37:51 by seungjpa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <stdlib.h>

static int	count_arr(char const *str, char charset)
{
	int	count;
...
static int	assign(char const *str, char charset, char **bound)
{
	int	count;
	int	i;
...
static void	mal_free(char **bound, int index)
{
	int	count;
...
static int	work(char const *str, char charset, char **bound)
{
	int	index;
	int	count_assign;
